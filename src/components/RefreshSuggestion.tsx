...
const RefreshSuggestion = ({ suggestion, onClose }: RefreshSuggestionProps) => {
  //5秒後に自動で閉じる
  useEffect(() => {
    if (suggestion) {
    ...
    <AnimatePresence>
      {suggestion && (
        ...
        >
          ...
          <p className="text-lg font-medium text-gray-700 pr-6 text-center">
            {suggestion}
          </p>
        </motion.div>
      )}
...
export default RefreshSuggestion;
